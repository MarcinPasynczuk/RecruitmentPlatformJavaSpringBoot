...
<td>
    ...
    <a href="move-to-next-stage?id=${employee.id}" class="btn btn-success">Move to Next Stage</a>
...
<div>
    <h1>CV Moved to the Next Stage</h1>
    <table class="table table-striped">
        <thead>
            <tr>
                <th>Name</th>
                ...
                <th>Agree to Terms</th>
                <th>CV Checked</th>
                <th>Actions</th> <!-- Dodanie kolumny Actions -->
            </tr>
        </thead>
        <tbody>
            <c:forEach items="${nextStageEmployees}" var="employee">
                <tr>
                    <td>${employee.name}</td>
                    <td>${employee.email}</td>
                    <td>${employee.phoneNumber}</td>
