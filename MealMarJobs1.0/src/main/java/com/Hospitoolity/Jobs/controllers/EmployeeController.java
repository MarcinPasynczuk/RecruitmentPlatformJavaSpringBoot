...
public class EmployeeController {
    ...
    Employee employee = new Employee(null, application.getName(), application.getEmail(), application.getPhoneNumber(), application.getPosition(), resumeData, application.getCoverLetter(), application.isAgreeToTerms(), application.isCvChecked(), false);
